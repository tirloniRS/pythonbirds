...
class Motor:
    ...
    def frear(self):
        self.velocidade -= 2
        self.velocidade = max(0, self.velocidade) # se a velocidade for negativa, mantém o zero

# todos caracteres em caixa alta, significa que é uma constante, e não deve ser alterada
NORTE = 'Norte'
SUL = 'Sul'
LESTE = 'Leste'
OESTE = 'Oeste'
